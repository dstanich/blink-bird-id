...
const PROMPT = "Identify the bird or birds in the attached screenshot. Return a JSON array of objects with the following format: { \"isBird\": true or false, \"species\": \"common species name in all lower case letters\", \"gender\": \"male or female\", \"count\": number of birds of this species in the screenshot, \"confidence\": confidence score between 0 and 1, \"nonBirdSpecies\": \"non-bird species if any\" }.  Only return JSON, do not return any other data.  If the screenshot has no bird set isBird to false and set nonBirdSpecies to the most prominent non-bird object in the image, if any.  Do not put the JSON in a codeblock, return only JSON.";
